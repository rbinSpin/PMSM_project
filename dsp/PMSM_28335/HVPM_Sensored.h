...
#include "spi_setting.h"        // Include header for the SPI_TRANSFER object
#include "lqr.h"                // Include header for the LQR object
//#include "sdre.h"               // Include header for the SDRE object
